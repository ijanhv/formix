...
const FormCode = ({ code, schema }: { code: string; schema: string }) => {
  return (
    <Dialog>
      <DialogTrigger>Show Code</DialogTrigger>
      <DialogContent className="max-w-6xl">
        <DialogHeader className="w-full ">
          <DialogDescription className="w-full max-h-[80vh]  overflow-y-auto scrollbar scrollbar-w-0 ">
