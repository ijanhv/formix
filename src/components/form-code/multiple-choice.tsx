...
const MultipleChoiceCode = ({ theme }: { theme: Theme }) => {
  return (
    <SyntaxHighlighter
      language="javascript"
      style={nightOwl}
            ...
            {options.map((option, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={\`w-6 h-6 rounded-md flex items-center justify-center \${isChecked ? ${theme.buttonColor} : ""}\`}>
...
export default MultipleChoiceCode;
